...
class Interactable:
    ...
    def __init__(self, x, y, size, batch, group, label_group=None,
                 idle_color=(150, 150, 150), active_color=(240, 220, 80),
        ...
        self.rect = pyglet.shapes.Rectangle(
            x, y, size, size, color=idle_color, batch=batch, group=group,
        )
